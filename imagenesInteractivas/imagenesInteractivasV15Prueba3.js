...
function CambiarImagen(){
    ...
    completeImg1.style.width = '150px'
    completeImg2.style.width = '150px'
    completeImg3.style.width = '150px'
    completeImg4.style.width = '150px'
    completeImg5.style.width = '150px'
    completeImg6.style.width = '150px'
    completeImg7.style.width = '150px'
    grupo1.style.width = '150px'
    ruedos1.style.width = '150px'
    ruedos2.style.width = '150px'
    
    
    imagen.style.height = '150px'
    completeImg1.style.height = '150px'
    completeImg2.style.height = '150px'
    completeImg3.style.height = '150px'
    completeImg4.style.height = '150px'
    completeImg5.style.height = '150px'
    completeImg6.style.height = '150px'
    completeImg7.style.height = '150px'
    grupo1.style.height = '150px'
    ruedos1.style.height = '150px'
    ruedos2.style.height = '150px'
