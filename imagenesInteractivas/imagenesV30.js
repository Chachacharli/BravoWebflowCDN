  ...
  function CambiarImagen(){
    ...
    innerPrecioM.innerHTML = ("$"+precio)
    innerPesoM.innerHTML = (peso +"Kg");
    
    ACABADO.style.width ='50%'
    ACABADO.style.height ='50%'
    ...
    ACABADO.style.width ='100%'
    ACABADO.style.height ='100%'
  ...
  var innerPesoM = document.getElementById('innerPesoM');
  var innerPrecioM = document.getElementById('innerPrecioM');
  ...
  var ACABADO = document.getElementsByClassName('acabadoInteractivo2')

  var gifImgLoading = 'https://uploads-ssl.webflow.com/6149043a3c69c4356cdb74b7/62e8909354b3000715341c62_loader.gif';
