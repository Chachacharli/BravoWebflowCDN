  ...
  var ruedos2 =  document.querySelector('#ruedos2');

    
  var imagenMobile = document.getElementById('imagenMobile');
  var completeImg1Mobile = document.getElementById('completeImg1Mobile');
  var completeImg2Mobile = document.getElementById('completeImg2Mobile');
  var completeImg3Mobile = document.getElementById('completeImg3Mobile');
  var completeImg4Mobile = document.getElementById('completeImg4Mobile');
  var completeImg5Mobile = document.getElementById('completeImg5Mobile');
  var completeImg6Mobile = document.getElementById('completeImg6Mobile');
  var completeImg7Mobile = document.getElementById('completeImg7Mobile');
  var grupoMobile1 =  document.getElementById('grupoMobile1');
  var ruedos1Mobile = document.getElementById('ruedos1Mobile');
  var ruedos2Mobile =  document.getElementById('ruedos2Mobile');
  ...
  select.addEventListener('change',
    function(){
        ...
        cambioSelect = document.getElementById(`${selectedOption.value}`);            
  ...
  Medium.addEventListener("mouseover", () =>{
    ...
    if("Medium" == selectedOption.value ){
  ...
  XLarge.addEventListener("mouseover", () =>{
    if("XLarge" == selectedOption.value ){
    }else{
