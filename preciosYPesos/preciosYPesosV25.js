...
LIST_OF_SIZEBIKE.forEach( (e) => {
    e.addEventListener('change', (event) => {
        if (event.target.checked) {
            ...
            PRECIO_TAMANO = event.target.getAttribute('precio')
            SetPrecio();
        }    
});
})
...
LIST_OF_GROUPSET.forEach( (e) => {
    e.addEventListener('change', (event) => {
        if (event.target.checked) {
            console.log(event.target)
            PRECIO_GRUPO = event.target.getAttribute('precio')
            SetPrecio();
        }    
});
})
...
LIST_OF_RINES.forEach( (e) => {
    e.addEventListener('change', (event) => {
        if (event.target.checked) {
            console.log(event.target)
            PRECIO_RUEDOS = event.target.getAttribute('precio')
            SetPrecio();
        }    
});
})
...
LIST_OF_MANUBRIO.forEach( (e) => {
    e.addEventListener('change', (event) => {
        if (event.target.checked) {
            console.log(event.target)
            PRECIO_MANUBRIO = event.target.getAttribute('precio')
            SetPrecio();
        }    
});
})
...
LIST_OF_BASE.forEach( (e) => {
    e.addEventListener('change', (event) => {
        if (event.target.checked) {
            console.log(event.target)
            PRECIO_BASE = event.target.getAttribute('precio')
            SetPrecio();
        }    
});
})
...
LIST_OF_DISENO.forEach( (e) => {
    e.addEventListener('change', (event) => {
        if (event.target.checked) {
            console.log(event.target)
            PRECIO_DISENO = event.target.getAttribute('precio')
            SetPrecio();
        }    
});
})
...
function SetPrecio(){
    ...
    innerPrecio.innerText = PESO_GRUPO + PESO_RUEDOS + PESO_MANUBRIO + PESO_BASE + PESO_DISENO + PESO_TAMANO;
    innerPrecioM.innerText = PESO_GRUPO + PESO_RUEDOS + PESO_MANUBRIO + PESO_BASE + PESO_DISENO + PESO_TAMANO;
