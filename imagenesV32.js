  ...
  function CambiarImagen(){
    ...
    precio = 60000 + typeC + groudsetC + rinC + baseC+  estiloC + disenoC + anozC  +seatpostC+headsetC+ stemC;
    peso  = 8.1 + typeP + groudsetP + rinP + baseP+  estiloP + disenoP + anozP  +seatpostP+headsetP+ stemP;
